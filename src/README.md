...
```sh
docker build -t Power2People .
docker run -p 8080:80 Power2People
# open http://localhost:8080
```

## Questions? Issues?

The [GitHub repo for this template is here](https://github.com/robconery/Power2People). I don't have discussions enabled, but feel free to pop an issue if you like or, better yet, a PR!
